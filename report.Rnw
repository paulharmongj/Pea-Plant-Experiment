...
<<assess, echo = FALSE, fig.height = 4, fig.width = 6, fig.align = 'center'>>=
...
plot1 <- ggplot(diag) + geom_point(aes(Fitted, Residuals), col = "red") + ggtitle("Residual Plot") + xlab("Fitted Values") + theme_economist_white() 
