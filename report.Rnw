...
beanplot(Height ~ Block, data = pea, col = c("lawngreen",'forestgreen'), ylab = "Plant Height (mm)", xlab = 'block', main = "Plant Heights by Block")
